...
export class ChatComponent implements OnInit, OnDestroy {
  ...
  loadCurrentUser(): void {
    try {
      ...
      if (userProfile) {
        ...
        this.currentUserId = profile.data.userId;
        this.currentUserName = profile.data.fullName;
        this.currentUserAvatar = profile.data.avatar;
      }
    } catch (error) {
  ...
  sendMessage(): void {
    ...
    // Gửi qua HTTP API (không phải WebSocket)
